...
function startHeartbeat() {
  ...
  heartbeatInterval = setInterval(() => {
    if (clients.size > 0) {
      const heartbeatMessage = { type: 'heartbeat', timestamp: new Date().toISOString() };
      sendSSEMessage(heartbeatMessage);
    }
  }, 15000); // Send heartbeat every 15 seconds for development
